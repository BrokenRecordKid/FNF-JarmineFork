...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Jarmine Fork"],
			["Broken Record Kid",		"exavier",		"basically jarmine fork",					"https://www.youtube.com/channel/UCm05sMQ-eEZInw2DP3-0Z1w",	"34368B"],
			[""],
			["Funkin' Crew"],
			...
			[""],
			['Psych Engine DS'],
			['Dsfan2',				'ds',				'Some Modifications to Base Psych Engine (Owner/Coder of Psych Engine DS)',							'https://www.youtube.com/channel/UC5ll8qg39youNX11mCCwI7Q','FF0000'],
