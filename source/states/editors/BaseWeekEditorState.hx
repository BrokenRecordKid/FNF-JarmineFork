...
class BaseWeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
...
class WeekEditorFreeplayState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	function addFreeplayUI() {
		...
		tab_group.add(new FlxText(10, iconInputText.y - 18, 0, 'Selected icon or psych ds album cover:'));
