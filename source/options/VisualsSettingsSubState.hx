...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('Dynamic Arrow-Based Healthbar',
			"If checked, this adds a custom healthbar with custom animations.",
			'coolFuckingHealthbar',
			BOOL);
		addOption(option);
		...
		var option:Option = new Option('PsychUI Theme/Colors:',
			"Change the PsychUI colors! (mainly in the debug menus)",
			'yooEyeColorShit',
			STRING,
			['Psych', 'Blue', 'Pink']);
		addOption(option);
		...
		var option:Option = new Option('Psych Engine DS Rating Animations',
			"If checked, the ratings will use the Psych Engine DS animations",
			'psychDSRatingAnims',
			BOOL);
		addOption(option);
